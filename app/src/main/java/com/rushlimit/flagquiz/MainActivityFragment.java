...
public class MainActivityFragment extends Fragment {
    ...
    private int correctAnswers; // number of correct guesses made
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        quizLinearLayout = (LinearLayout) rootView.findViewById(R.id.quizLinearLayout);
        questionNumberTextView = (TextView) rootView.findViewById(R.id.questionNumberTextView);
        flagImageView = (ImageView) rootView.findViewById(R.id.flagImageView);
        guessLinearLayouts = new LinearLayout[4];
        guessLinearLayouts[0] = (LinearLayout) rootView.findViewById(R.id.row1LinearLayout);
        guessLinearLayouts[1] = (LinearLayout) rootView.findViewById(R.id.row2LinearLayout);
        guessLinearLayouts[2] = (LinearLayout) rootView.findViewById(R.id.row3LinearLayout);
        guessLinearLayouts[3] = (LinearLayout) rootView.findViewById(R.id.row4LinearLayout);
    ...
    // Sets up and start the next quiz
    public void resetQuiz() {
        ...
        try {
            for (String region : regionsSet) {
                // Get a list of all flag image fies in this region
            ...
            Log.d(TAG, "Error loading image file names", e);
        }
    ...
    private void animate(boolean animateOut) {
        ...
        animator.setDuration(500); // Animation duration (ms)
        animator.start();
    }
    ...
    private View.OnClickListener guessButtonListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (guess.equals(answer)) {
                ...
                answerTextView.setText(getString(R.string.correct_answer, answer));
                ...
                if (correctAnswers == FLAGS_IN_QUIZ) {
                    ...
                    // Use FragmentManager to show display the DialogFragment
                ...
                guessButton.setEnabled(false); // Disable the incorrect button
            }
        }
    };

    // Utility method that disables all the answer buttons
